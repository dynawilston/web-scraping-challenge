{
 "cells": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "   window.NREUM||(NREUM={});NREUM.info={\"beacon\":\"bam.nr-data.net\",\"errorBeacon\":\"bam.nr-data.net\",\"licenseKey\":\"5e33925808\",\"applicationID\":\"59562082\",\"transactionName\":\"JVcPR0MLWApSRU1eAQVVEhxSC1oSUlkWbBMHXwRAHhdcCUA=\",\"queueTime\":0,\"applicationTime\":392,\"agent\":\"\"}\n",
      "  </script>\n",
      "  <script type=\"text/javascript\">\n",
      ...
      "   <meta content=\"7+2DA96KNL0nyMzL2t4T0l/NZBO9MwFFYD8Xe9ZRHXvawB/yMFgSsgGHzcKyZ973iPSduevYxyQKcQFUJKhfAQ==\" name=\"csrf-token\">\n",
      "    <title>\n",
      ...
      "    <link href=\"/assets/public_manifest-26ef5d3f1cc6538bb0765c4fe6893a52b7c3865d2527a6318234ae66b1c34920.css\" media=\"all\" rel=\"stylesheet\">\n",
      ...
      "       <script src=\"/assets/public_manifest-3e44c9526754a7246e0626133c30229d8e9fd9a6cb758f475a6edf29b6d59dcf.js\">\n",
      "       </script>\n",
  ...
  },
  {
   ...
   "source": [
    "#Scrape description of News Titles \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "#UnboundLocalError: local variable 'e' referenced before assignment. Make sure to update browser to latest version. \n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "featured_image_url = 'https://www.jpl.nasa.gov/spaceimages/images/wallpaper/PIA18245-1920x1200.jpg'\n",
    "    "
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "#scrape the Mars twitter account and grab the tweet text \n",
  ...
  },
  {
   ...
   "source": [
    "latest_tweet = soup.find(\"span\", class_ = \"css-901oao.css-16my406.r-1qd0xha.r-ad9z0x.r-bcqeeo.r-qvutc0\")\n",
    "\n",
    "print(latest_tweet)\n",
    "#unable to scrape twitter data"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    "#scrape data about Mars from a table\n",
 ...
 "metadata": {
  "kernelspec": {
   ...
   "language": "python",
   "name": "aa7f71d0-1252-4810-b9c6-b2c66f018205"
  },
  "language_info": {
   "codemirror_mode": {
    "name": "ipython",
